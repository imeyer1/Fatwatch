...
class Customers(db.Model):
    ...
    cus_timestamp = db.Column(db.DateTime,default = datetime.now)
    ...
    def __repr__(self):
        return f"Customers( {self.cus_timestamp}',{self.cust_name}','{self.cust_address}',{self.cust_zip}',{self.cust_city}',{self.cust_phone}',{self.cust_email}','{self.cust_active}')"
