...
$(document).on('click', '.btn_save', function (event) 
{
    ...
    //show message
     ...
     //output to change
    $.post("/update", {arr:arr, "title":title, "prefix":prefix,"val":title}, function(data) {$("#displaymessage").html(data);
    $("#displaymessage").show();
    $('#table').html(function() {
        ...
        //output to change
        $.post("/add", {arr:arr, "title":title, "prefix":prefix, "val":title}, function(data) {$("#displaymessage").html(data);
        $("#displaymessage").show();
        $('#table').html(function() {
            location.reload(true);
        });
...
$(document).on('click',".btn_search", function(event)
{
    ...
    var title = document.getElementsByClassName("title")[0].innerHTML;
    var prefix = document.getElementsByClassName("prefix")[0].innerHTML;
    var searchText = $('#table').find("#fldSearch").html();
    
    $.post("/search", {"searchText":searchText,"title":title, "prefix":prefix,})
