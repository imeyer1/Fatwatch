...
def customers():
    ...
    newData3 = [tuple(s if s != False else "false" for s in tup) for tup in newData2]
    print(newData)
  


    return render_template('customers.html', title='Contacts', headings= headings, data=newData3, username=current_user.usr_name, form=form)
