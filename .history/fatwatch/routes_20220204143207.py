    ...
    for e in list(newData):
        ...
        for x in list(e):
            if isinstance(x, datetime):
                ...
                list(e)[pos]= d
                newData2.append(list(e))
        print(tuple(newData2))    
    return render_template('customers.html', title='Contacts', headings= column_names, data=newData2, username=current_user.usr_name, form=form)
