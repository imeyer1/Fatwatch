...
def customers():
    ...
    return render_template('customers.html', title=title, headings= headings, data=newData2, username=current_user.usr_name, form=form)
...
def delete():
    ...
    table =request.form['title'].strip()
