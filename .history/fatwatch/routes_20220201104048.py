...
@app.route('/customers_update/<int:id>', methods=['GET', 'POST'])
@login_required
def update(id):
    form = CustomersForm()
    ...
    if request.method == "POST":
        ...
        name_to_update.adress = request.form['address']
        name_to_update.zip = request.form['zip']
        ...
        try:
            ...
            return render_template_modal("customers_update.html", 
            form=form,
